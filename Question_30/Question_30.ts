...
let users = ['Admin', 'Eric', 'Emily', 'Stephen', 'Mike', 'Lily']
users.forEach((val) => {
    if(val === "Admin") console.log('Hello admin, would you like to see a status report?')
    else console.log(`Hello ${val}, thank you for logging in again.`)
})